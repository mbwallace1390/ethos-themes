...
Install the ZIP with ETHOS Suite's local ZIP installer. For manual ZIP installation, create `scripts/theme-abyss/` on the transmitter and extract the ZIP contents into that folder.
...
To install from repository sources, copy `theme-abyss` into the transmitter `scripts` folder, restart, and select **Abyss** under **System > General > Theme**.
