...
local function init()
    ...
    local logoOk, toolbarLogo = pcall(lcd.loadBitmap, "logo-phosphor-green.png")
    ...
    system.registerTheme({
        ...
        colors = {
            ...
            lcd.RGB(0x6B, 0x75, 0x6D), -- DISABLE_COLOR
            ...
            lcd.RGB(0x8A, 0x92, 0x8C), -- INACTIVE_COLOR
        ...
        toolbarBackground = loadToolbar("toolbar-phosphor-green.png", "toolbar-phosphor-green-x18.png"),
    })
end
