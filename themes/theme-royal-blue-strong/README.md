...
Copy `theme-royal-blue-strong` into the transmitter's `scripts` folder, restart, and select **Royal Blue Strong** under **System > General > Theme**.
