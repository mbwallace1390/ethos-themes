...
Copy the complete `theme-rf-crimson-pro` folder into the transmitter's `scripts` folder, restart, and select **RF Crimson Pro** under **System > General > Theme**.
