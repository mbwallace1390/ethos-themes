...
local function init()
    system.registerTheme({
        ...
        colors = {
            ...
            lcd.RGB(0x5E, 0x63, 0x69), -- DISABLE_COLOR
            ...
            lcd.RGB(0x6C, 0x71, 0x77), -- INACTIVE_COLOR
        ...
        toolbarBackground = lcd.loadBitmap(selectToolbar("toolbar-blue-vector.png", "toolbar-blue-vector-x18.png")),
    })
end
