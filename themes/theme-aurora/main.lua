...
local function init()
    ...
    system.registerTheme({
        ...
        colors = {
            ...
            lcd.RGB(0x74, 0x7B, 0x85), -- DISABLE_COLOR
            ...
            lcd.RGB(0xB1, 0x7F, 0xFF), -- ACTIVE_COLOR
            lcd.RGB(0x93, 0x99, 0xA1), -- INACTIVE_COLOR
        ...
        toolbarBackground = loadToolbar("toolbar-aurora.png", "toolbar-aurora-x18.png"),
    })
end
