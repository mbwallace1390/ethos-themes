...
local function init()
    ...
    local logoOk, toolbarLogo = pcall(lcd.loadBitmap, "logo-molten-ember.png")
    ...
    system.registerTheme({
        ...
        toolbarBackground = loadToolbar("toolbar-molten-ember.png", "toolbar-molten-ember-x18.png"),
    })
end
