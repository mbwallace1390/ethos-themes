...
Copy the complete `theme-rf-violet-pro` folder into the transmitter's `scripts` folder, restart, and select **RF Violet Pro** under **System > General > Theme**.
