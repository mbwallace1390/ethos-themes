...
local function init()
    ...
    local logoOk, toolbarLogo = pcall(lcd.loadBitmap, "logo-summit.png")
    ...
    system.registerTheme({
        ...
        colors = {
            ...
            lcd.RGB(0x7E, 0x7D, 0x7B), -- DISABLE_COLOR
            ...
            lcd.RGB(0x9C, 0x9C, 0x9A), -- INACTIVE_COLOR
        ...
        toolbarBackground = loadToolbar("toolbar-summit.png", "toolbar-summit-x18.png"),
    })
end
