...
Copy the complete `theme-rf-magenta-pro` folder into the transmitter's `scripts` folder, restart, and select **RF Magenta Pro** under **System > General > Theme**.
