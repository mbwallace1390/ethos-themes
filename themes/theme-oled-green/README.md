...
Install the ZIP with ETHOS Suite's local ZIP installer. For manual ZIP installation, create `scripts/theme-oled-green/` on the transmitter and extract the ZIP contents into that folder.
