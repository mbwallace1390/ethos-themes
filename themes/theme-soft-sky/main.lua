...
local function init()
    system.registerTheme({
        ...
        colors = {
            ...
            lcd.RGB(0x75, 0x7A, 0x7F), -- DISABLE_COLOR
            ...
            lcd.RGB(0x85, 0x8A, 0x8F), -- INACTIVE_COLOR
        ...
        toolbarBackground = lcd.loadBitmap(selectToolbar("toolbar-soft-sky.png", "toolbar-soft-sky-x18.png")),
    })
end
