...
- Install the current ZIP through ETHOS Suite's local ZIP installer; confirm it is recognized and targets `scripts/<theme-folder>` (America 250 v1.2.1, Ink & Halo v1.0.1, remaining themes v1.2.0).
